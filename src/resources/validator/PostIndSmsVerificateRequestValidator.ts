...
export default class PostIndSmsVerificateRequestValidator implements ExpressMiddlewareInterface {
    async use (request: Request, response: Response, next: NextFunction): Promise<void> {
        ...
        const dto = await transformAndValidate(PostIndSmsVerificateReqDto, request.body);
