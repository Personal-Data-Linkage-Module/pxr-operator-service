...
jest.mock('../repositories/postgres/SessionRepository', () => {
    return {
        default: jest.fn().mockImplementation(() => {
            return {
                getRecordFromId: jest.fn(async (sessionId: string): Promise<SessionEntity | null> => {
                    return null;
                })
            };
        })
...
describe('operator API', () => {
     ...
     */
    describe('更新 異常系', () => {
        test('ライブラリエラー（isSessionIdExists）', async () => {
            // 事前データ準備
            await common.executeSqlString(`
                ...
                VALUES
                (
                    '437a5cbc10da802a887f5e057c88fdc64a927332871ad2a987dfcb7d224e7e00', 2, '2025-01-27 13:45:57.641',
